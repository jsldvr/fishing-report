    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid gap-8">
        ...
        <div className="card p-6" id="source-spec-sheet-card">
          <h2 className="text-xl font-semibold mb-4" id="source-spec-sheet-heading">Source Spec Sheet</h2>
          <div className="space-y-4" id="source-spec-sheet-content">
            <p className="text-gray-600 leading-relaxed" id="source-spec-intro">
              ...
              codebase. Follow the checkpoints below to clone, fork, and deploy your own instance.
            </p>
            <ul className="text-sm text-gray-600 space-y-3" id="source-spec-steps">
              <li className="leading-relaxed" id="source-spec-step-1">
                <span className="font-medium text-gray-900" id="source-spec-step-1-label">Deploy Beacon:</span>{' '}
                Fork the repository from GitHub so your squad has a safe staging ground.
              </li>
              <li className="leading-relaxed" id="source-spec-step-2">
                <span className="font-medium text-gray-900" id="source-spec-step-2-label">Secure Local Copy:</span>{' '}
                Clone the fork with{' '}
                <code className="bg-gray-100 px-1 rounded" id="source-spec-step-2-command">git clone https://github.com/&lt;your-handle&gt;/fishing-report.git</code>{' '}
                and navigate into the project folder.
              </li>
              <li className="leading-relaxed" id="source-spec-step-3">
                <span className="font-medium text-gray-900" id="source-spec-step-3-label">Resupply Dependencies:</span>{' '}
                Run{' '}
                <code className="bg-gray-100 px-1 rounded" id="source-spec-step-3-command">npm install</code>{' '}
                to provision all mission-critical packages.
              </li>
              <li className="leading-relaxed" id="source-spec-step-4">
                <span className="font-medium text-gray-900" id="source-spec-step-4-label">Launch Field Ops:</span>{' '}
                Use{' '}
                <code className="bg-gray-100 px-1 rounded" id="source-spec-step-4-command">npm run dev</code>{' '}
                to activate the local dev server, or{' '}
                <code className="bg-gray-100 px-1 rounded" id="source-spec-step-4b-command">npm run build</code>{' '}
                for a production-ready kit.
              </li>
            </ul>
            <p className="text-xs text-gray-500" id="source-spec-outro">
              Field intel: the project relies on Vite + React 18 with TypeScript, so keep Node 18+ in your go-bag.
            </p>
          </div>
        </div>
